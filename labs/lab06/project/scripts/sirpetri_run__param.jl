# # Параметрический эксперимент: начальное число инфицированных
#
# Дополнительный эксперимент проверяет, как I(0) влияет на время раннего пика.
# Для каждого варианта выполнено 12 реальных стохастических повторов.
