...
#
# Исследуем влияние скорости роста $\alpha$ на траекторию, итоговое значение и
# время удвоения модели $du/dt=\alpha u$.
#
...
# ## Зависимость времени удвоения от скорости роста
